...
public class ConfigShow {
    ...
    public void setTime_start_popup(int time_start_popup) {
    ...
    public void setOffset_show_popup(int offset_show_popup) {
    ...
    public void setTime_start_banner(int time_start_banner) {
    ...
    public void setOffset_show_banner(int offset_show_banner) {
        this.offset_show_banner = offset_show_banner;
    }
}
